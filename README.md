...
conda activate TF_FM
#164
cd /gruntdata3/xinting/project/CADR_FixMatch
export ML_DATA="/gruntdata3/xinting/project/CADR_FixMatch/data"
export dPYTHONPATH=$PYTHONPATH:"/gruntdata3/xinting/project/CADR_FixMatch"

#44
cd /gruntdata0/xinting/project/CADR_FixMatch
export ML_DATA="/gruntdata0/xinting/project/CADR_FixMatch/data"
export PYTHONPATH=$PYTHONPATH:"/gruntdata0/xinting/project/CADR_FixMatch"
...
CUDA_VISIBLE_DEVICES= scripts/create_unlabeled.py $ML_DATA/SSL2/cifar10_LT_50_RS $ML_DATA/cifar10-train.tfrecord &
CUDA_VISIBLE_DEVICES= scripts/create_unlabeled.py $ML_DATA/SSL2/cifar10_LT_20 $ML_DATA/cifar10-train.tfrecord &
CUDA_VISIBLE_DEVICES= scripts/create_unlabeled.py $ML_DATA/SSL2/cifar10_LT_50 $ML_DATA/cifar10-train.tfrecord &


python scripts/create_unlabeled.py $ML_DATA/SSL2/stl10 $ML_DATA/stl10-train.tfrecord $ML_DATA/stl10-unlabeled.tfrecord &

CUDA_VISIBLE_DEVICES= scripts/create_unlabeled.py $ML_DATA/SSL2/cifar10_LT_100 $ML_DATA/cifar10_LT_100-train.tfrecord &
CUDA_VISIBLE_DEVICES= scripts/create_unlabeled.py $ML_DATA/SSL2/cifar100_LT_50 $ML_DATA/cifar100_LT_50-train.tfrecord &
CUDA_VISIBLE_DEVICES= scripts/create_unlabeled.py $ML_DATA/SSL2/cifar100_LT_100 $ML_DATA/cifar100_LT_100-train.tfrecord &
CUDA_VISIBLE_DEVICES= scripts/create_unlabeled.py $ML_DATA/SSL2/cifar100_LT_200 $ML_DATA/cifar100-train.tfrecord &
CUDA_VISIBLE_DEVICES= scripts/create_unlabeled.py $ML_DATA/SSL2/cifar100_rand $ML_DATA/cifar100-train.tfrecord &

CUDA_VISIBLE_DEVICES= scripts/create_unlabeled.py $ML_DATA/SSL2/stl10_LT_50 $ML_DATA/stl10-train.tfrecord $ML_DATA/stl10-unlabeled.tfrecord &

CUDA_VISIBLE_DEVICES= scripts/create_unlabeled.py $ML_DATA/SSL2/stl10_rand $ML_DATA/stl10-train.tfrecord $ML_DATA/stl10-unlabeled.tfrecord &

CUDA_VISIBLE_DEVICES= scripts/create_unlabeled.py $ML_DATA/SSL2/stl10_LT_100 $ML_DATA/stl10-train.tfrecord $ML_DATA/stl10-unlabeled.tfrecord &
CUDA_VISIBLE_DEVICES= scripts/create_unlabeled.py $ML_DATA/SSL2/svhn_rand $ML_DATA/svhn-train.tfrecord $ML_DATA/svhn-extra.tfrecord &
python scripts/create_unlabeled.py $ML_DATA/SSL2/svhn_LT_50 $ML_DATA/svhn-train.tfrecord $ML_DATA/svhn-extra.tfrecord &
python scripts/create_unlabeled.py $ML_DATA/SSL2/tmp $ML_DATA/tmp.tfrecord &


python scripts/create_unlabeled.py $ML_DATA/SSL2/cifar10_IT_50 --size=5000 --lamda=50 $ML_DATA/cifar10-train.tfrecord &
python scripts/create_unlabeled.py $ML_DATA/SSL2/cifar10_BT_50 --size=5000 --lamda=50 $ML_DATA/cifar10-train.tfrecord &

python scripts/create_unlabeled.py $ML_DATA/SSL2/cifar10_LT_50 $ML_DATA/cifar10-train.tfrecord &

python scripts/create_test.py $ML_DATA/cifar10_debug $ML_DATA/cifar10-test.tfrecord &
...
python scripts/create_split.py --seed=1 --size=40 $ML_DATA/SSL2/svhn $ML_DATA/svhn-train.tfrecord $ML_DATA/svhn-extra.tfrecord &
python scripts/create_split.py --seed=1 --size=4000 $ML_DATA/SSL2/cifar10 $ML_DATA/cifar10-train.tfrecord &
python scripts/create_split.py --seed=1 --size=10000 $ML_DATA/SSL2/cifar100_rand $ML_DATA/cifar100-train.tfrecord &

python scripts/create_split.py --seed=1 --size=40 $ML_DATA/SSL2/cifar10_IT_50 $ML_DATA/cifar10-train.tfrecord &
...
# for LT-label dataset 
for seed in 0 1 2 3 4 5; do
    for size in 100 50; do
        python scripts/create_split.py --seed=$seed --size=$size --lamda=50 $ML_DATA/SSL2/cifar10_LT_50 $ML_DATA/cifar10-train.tfrecord &
    done
done 

python scripts/create_split.py --seed=3 --size=50 --lamda=50 $ML_DATA/SSL2/cifar10_LT_50 $ML_DATA/cifar10-train.tfrecord &

for seed in 0 1 2 3 4 5; do
    for size in 100 200; do
        CUDA_VISIBLE_DEVICES= scripts/create_split.py --seed=$seed --size=$size --lamda=100 $ML_DATA/SSL2/cifar10_LT_100 $ML_DATA/cifar10-train.tfrecord &
    done
    wait
done 

python scripts/create_split.py --seed=1 --size=20 --lamda=20 $ML_DATA/SSL2/cifar10_LT_20 $ML_DATA/cifar10-train.tfrecord &

for seed in 0 1 2 3 4 5; do
    for size in 50, 100, 200; do
        CUDA_VISIBLE_DEVICES= scripts/create_split.py --seed=$seed --size=$size --lamda=50 $ML_DATA/SSL2/cifar100_LT_50 $ML_DATA/cifar100-train.tfrecord &
    done
    wait
done 
...
for seed in 0 1 2 3 4 5; do
    for size in 100, 200; do
        CUDA_VISIBLE_DEVICES= scripts/create_split.py --seed=$seed --size=$size --lamda=100 $ML_DATA/SSL2/cifar100_LT_100 $ML_DATA/cifar100_LT_100-train.tfrecord &
    done
    wait
done 

```
python scripts/create_split.py --seed=1 --size=10 $ML_DATA/SSL2/tmp_10 $ML_DATA/tmp &


python scripts/create_split.py --seed=1 --size=10000 $ML_DATA/SSL2/cifar100 $ML_DATA/cifar100-train.tfrecord &

python scripts/create_split.py --seed=1 --size=50 --lamda=50 $ML_DATA/SSL2/cifar10_LT_50_RS $ML_DATA/cifar10-train.tfrecord &

python scripts/create_split.py --seed=1 --size=50 --lamda=50 $ML_DATA/SSL2/cifar10_LT_50 $ML_DATA/cifar10-train.tfrecord &

python scripts/create_split.py --seed=1 --size=100 --lamda=100 $ML_DATA/SSL2/stl10_LT_100 $ML_DATA/stl10-train.tfrecord &
python scripts/create_split.py --seed=1 --size=50 --lamda=50 $ML_DATA/SSL2/stl10_LT_50 $ML_DATA/stl10-train.tfrecord &

python scripts/create_split.py --seed=1 --size=10000 $ML_DATA/SSL2/stl10_rand $ML_DATA/stl10-train.tfrecord &
python scripts/create_split.py --seed=1 --size=100 --lamda=100 $ML_DATA/SSL2/svhn_LT_100 $ML_DATA/svhn-train.tfrecord $ML_DATA/svhn-extra.tfrecord &

python scripts/create_split.py --seed=1 --size=200 --lamda=200 $ML_DATA/SSL2/cifar100_LT_200 $ML_DATA/cifar100-train.tfrecord &


python scripts/create_split.py --seed=1 --size=1000 $ML_DATA/SSL2/stl10 $ML_DATA/stl10-train.tfrecord $ML_DATA/stl10-unlabeled.tfrecord &
### ImageNet

 python scripts/create_split.py --seed=1 --size=200 --lamda=200 $ML_DATA/SSL2/imagenet_LT_200 $ML_DATA/imagenet-train &
