...
_DATA_CACHE = None
SAMPLES_PER_CLASS = [1, 2, 3, 4, 5, 10, 20, 25, 100, 400]
...
def create_datasets(augment_fn):
    ...
    d.update([DataSets.creator('cifar10_LT_20', seed, label, valid, augment_fn)
          for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])
    d.update([DataSets.creator('cifar10_LT_50', seed, label, valid, augment_fn)
          for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000, 50000])])

    d.update([DataSets.creator('cifar10_LT_50_RS', seed, label, valid, augment_fn)
          for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])
    d.update([DataSets.creator('cifar10_LT_100_RS', seed, label, valid, augment_fn)
          for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])
    d.update([DataSets.creator('cifar10_LT_100', seed, label, valid, augment_fn)
          for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])

    d.update([DataSets.creator('cifar10_IT_50', seed, label, valid, augment_fn)
          for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])

    d.update([DataSets.creator('cifar10_IT_R50', seed, label, valid, augment_fn)
          for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])
    d.update([DataSets.creator('cifar10_IT_R20', seed, label, valid, augment_fn)
          for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])
    d.update([DataSets.creator('cifar10_IT_R100', seed, label, valid, augment_fn)
          for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])

    d.update([DataSets.creator('cifar10_BT_50_10', seed, label, valid, augment_fn)
          for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])
    d.update([DataSets.creator('cifar10_BT_50_20', seed, label, valid, augment_fn)
          for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])
    d.update([DataSets.creator('cifar10_BT_50_50', seed, label, valid, augment_fn)
          for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])
    d.update([DataSets.creator('cifar10_BT_50_100', seed, label, valid, augment_fn)
          for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])

    d.update([DataSets.creator('cifar100_LT_50', seed, label, valid, augment_fn, nclass=100)
              for seed, label, valid in itertools.product(range(6), [50, 100, 200, 400, 1000, 2500, 10000], [1, 5000])])
    d.update([DataSets.creator('cifar100_LT_100', seed, label, valid, augment_fn, nclass=100)
              for seed, label, valid in itertools.product(range(6), [100, 200, 400, 1000, 2500, 10000], [1, 5000])])
    d.update([DataSets.creator('cifar100_LT_200', seed, label, valid, augment_fn, nclass=100)
              for seed, label, valid in itertools.product(range(6), [100, 200, 400, 1000, 2500, 10000], [1, 5000])])
    d.update([DataSets.creator('cifar100_rand', seed, label, valid, augment_fn, nclass=100)
              for seed, label, valid in itertools.product(range(6), [100, 200, 400, 1000, 2500, 5000, 10000], [1, 5000])])
    
    d.update([DataSets.creator('stl10_LT_100', seed, label, valid, augment_fn, height=96, width=96)
              for seed, label, valid in itertools.product(range(6), [100, 1000, 5000], [1, 500])])
    d.update([DataSets.creator('stl10_rand', seed, label, valid, augment_fn, height=96, width=96)
              for seed, label, valid in itertools.product(range(6), [100, 1000, 5000], [1, 500])])

    d.update([DataSets.creator('stl10_LT_50', seed, label, valid, augment_fn, height=96, width=96)
              for seed, label, valid in itertools.product(range(6), [50, 100, 1000, 5000], [1, 500])])
    d.update([DataSets.creator('svhn_rand', seed, label, valid, augment_fn)
              for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])

    d.update([DataSets.creator('svhn_LT_50', seed, label, valid, augment_fn)
            for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])
    d.update([DataSets.creator('svhn_LT_10', seed, label, valid, augment_fn)
            for seed, label, valid in itertools.product(range(6), [10 * x for x in SAMPLES_PER_CLASS], [1, 5000])])

    # d.update([DataSets.creator('tmp', seed, label, valid, augment_fn, nclass=100, height=84, width=84)
    #           for seed, label, valid in itertools.product(range(6), [10, 1000], [1, 5000])])
    # d.update([DataSets.creator('imagenet_LT_100', seed, label, valid, augment_fn, nclass=100, height=84, width=84)
    #           for seed, label, valid in itertools.product(range(6), [100, 1000], [1, 5000])])
    # d.update([DataSets.creator('imagenet_LT_200', seed, label, valid, augment_fn, nclass=100, height=84, width=84)
    #           for seed, label, valid in itertools.product(range(6), [100, 200, 1000], [1, 5000])])
    # d.update([DataSets.creator('imagenet_LT_50', seed, label, valid, augment_fn, nclass=100, height=84, width=84)
    #           for seed, label, valid in itertools.product(range(6), [50, 100, 200, 1000], [1, 5000])])
    return d
